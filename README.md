...
The image `ghcr.io/moritzboeker/ros_raspi_car:jazzy` (linux/arm64) contains the YDLidar SDK, all non-`COLCON_IGNORE` packages of this repo prebuilt, and `foxglove_bridge`. On start it runs `ros2 launch bringup bringup.py`.
