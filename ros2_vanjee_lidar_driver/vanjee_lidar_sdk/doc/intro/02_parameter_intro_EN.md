...
common:
  ...
  send_packet_ros: false                          # false: Topic for sending packets
...
lidar:
  - driver:
      ...
      ts_first_point: false                         # Whether the timestamp of the point cloud is the time of the first point, true=first point time, false=last point time
...
lidar:
  ...
  - driver:
      ...
      dense_points: false                           # Whether to remove points marked as NAN in the output point cloud
      ts_first_point: false                         # Whether the timestamp of the point cloud is the time of the first point. True = time of the first point, false = time of the last point
      publish_mode: 0                               # Echo mode: 0 - publish the first echo, 1 - publish the second echo, 2 - publish both echoes
      group_address: 0.0.0.0                        # Multicast address
